...
const REGISTRY: Record<PlatformId, PlatformMeta> = {
  ...
  eatsure: { id: "eatsure", name: "EatSure", short: "ES", color: "oklch(0.6 0.17 150)", bg: "oklch(0.6 0.17 150 / 0.12)", live: false, category: "food" },
  ...
  zepto: { id: "zepto", name: "Zepto", short: "ZP", color: "oklch(0.6 0.21 305)", bg: "oklch(0.6 0.21 305 / 0.12)", live: false, category: "grocery" },
  instamart: { id: "instamart", name: "Instamart", short: "IM", color: "oklch(0.64 0.19 40)", bg: "oklch(0.64 0.19 40 / 0.12)", live: false, category: "grocery" },
  bigbasket: { id: "bigbasket", name: "BigBasket", short: "BB", color: "oklch(0.58 0.16 155)", bg: "oklch(0.58 0.16 155 / 0.12)", live: false, category: "grocery" },
  jiomart: { id: "jiomart", name: "JioMart", short: "JM", color: "oklch(0.5 0.18 260)", bg: "oklch(0.5 0.18 260 / 0.12)", live: false, category: "grocery" },
}

export const LIVE_PLATFORMS: PlatformId[] = ["swiggy", "zomato", "blinkit"]
export const ROADMAP_PLATFORMS: PlatformId[] = [
  "magicpin",
  "eatsure",
  "ondc",
  "rapido",
